...
class Food:
    ...
    def __init__(self, window_size: tuple):
        ...
        x = random.randint(-self.window_size[0]/2 + 15, self.window_size[0]/2 - 15)
        y = random.randint(-self.window_size[1]/2 + 15, self.window_size[1]/2 - 40)
        self.position = (x, y)
    ...
    def update_random_food_position(self, snake)-> None:
        """
